...
<link rel="styleSheet" href="/css/GetBookData.css" />
    ...
    <div class="pt-5 pb-5">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="center">
                    <h3 class="main-heading pt-4 mt-5">Display Book's data</h3>
                </div>
        <table>
            <thead>
        <tr>
        ...
        <div class="right"><a href="/Menu"><button class="btn btn-primary">Back</button></a></div>
